		...
		<li className="flex flex-col justify-between mx-4 my-4 text-white rounded-md drop-shadow-xl sm:mx-auto sm:w-96 bg-gradient-to-r from-zinc-950 to-zinc-900">
			...
			<div className="flex m-4">
				<button
					...
					className="px-2 py-2 m-1 text-xs font-normal text-black transition-all duration-200 ease-linear bg-white rounded-md cursor-pointer sm:px-3 sm:font-semibold sm:text-sm hover:bg-zinc-800 hover:text-neutral-100"
				>
					VIEW ON MAP
				</button>
				<Modal
					...
					zoom={16}
				/>
				<button className="px-2 py-2 m-1 text-xs font-normal transition-all duration-200 ease-linear bg-green-600 rounded-md cursor-pointer sm:px-3 sm:font-semibold sm:text-sm hover:bg-green-800 ">
					EDIT
				</button>
				<button className="px-2 py-2 m-1 text-xs font-normal transition-all duration-200 ease-linear bg-red-600 rounded-md cursor-pointer sm:px-3 sm:font-semibold sm:text-sm hover:bg-red-800">
					DELETE
				</button>
			</div>
		</li>
